...
final class LicensingTest extends TestCase {
	...
	public function test_a_plan_grants_only_itself_except_pro(): void {
		...
		$this->assertSame(
			array( Plans::AI, Plans::AUTOMATIONS, Plans::PRO ),
